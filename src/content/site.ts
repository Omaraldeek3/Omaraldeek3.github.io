...
export const copy = {
  ar: {
    ...
    labIntro: "ثلاثة من هذه الأعمال تعمل الآن فعلاً، والرابع قيد البناء ومكتوب عليه ذلك.",
    labOpen: "افتح العمل",
    labLive: "يعمل الآن",
    labSoon: "قيد البناء",
  ...
  en: {
    ...
    fields: [
      ...
      { slug: "shorts-factory", title: "Automation systems", text: "Systems that connect tools, run on a schedule, and carry the work on without me standing over them." },
      { slug: "shorts-factory", title: "API integrations", text: "Wiring services together: keys kept safe, a fallback path when one stumbles, and failure that announces itself." },
    ...
    labIntro: "Three of these are running right now. The fourth is still being built, and says so.",
