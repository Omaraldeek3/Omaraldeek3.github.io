...
export default function Toolkit(){
 ...
 {active==='nest'?<NestWorkspace {...props}/>:active==='clean'||active==='repeat'?<EditWorkspace key={active} {...props} tool={active}/>:active==='cost'?<CostWorkspace lang={lang}/>:active==='kerf'?<KerfWorkspace lang={lang}/>:active==='box'?<BoxWorkspace lang={lang} onNest={onNest}/>:<ImageWorkspace key={active} lang={lang} tool={active} onNest={onNest}/>}
